...
[SFTP](https://en.wikipedia.org/wiki/SSH_File_Transfer_Protocol) | Secure File Transfer Protocol | For transferring files over SSH.

: Table 1: Internet Protocols {.striped .hover tbl-colwidths="[10,35,55]"}
