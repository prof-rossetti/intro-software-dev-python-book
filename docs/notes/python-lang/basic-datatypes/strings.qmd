...
We can alternatively use parentheses to represent a single string on multiple lines. This has a similar effect as concatenation in that it joins the component parts together:
