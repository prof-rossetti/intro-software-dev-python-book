...
# Prevent MathJax issues in PDF export
...
fig.write_image("docs/images/overview-plot-0.png")
```
...
fig.write_image("docs/images/overview-plot-1.png")
```
...
fig.write_image("docs/images/overview-plot-2.png")
```
...
fig.write_image("docs/images/overview-plot-3.png")
```
...
fig.write_image("docs/images/overview-plot-4.png")
```
...
fig.write_image("docs/images/overview-plot-5.png")
```
