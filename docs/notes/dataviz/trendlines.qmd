...
fig.write_image("docs/images/trendlines-plot-0.png")
```
...
fig.write_image("docs/images/trendlines-plot-1.png")
```
...
fig.write_image("docs/images/trendlines-plot-2.png")
```
